...
##LF: In general, I liked your script because it's very different than mine, and I learned new ways to do the same thing. I wrote some comments below in some of the chunks.
...
##LF: I like that you used object.size() to determine the size of the files.. I did not think of doing that.
```
...
##LF: i don't think there is a need to transpose the original file if you were going to transpose maize and teosinte again anyway.
```
...
##LF: I used loops in my assignment, but I liked seeing another way to do this part.
```
...
###LF: Did you mean another dataframe in the last plot? plot_genotypes does not exist and I can't view it
```
#Visualizations:
```{r}
...
##LF: Here is my script for this part (names have to be changed accordingly), but in this way you can also define the heterozygous ones too:
...
##LF: The above script did not work for me as I don't think genotypes_by_ID was defined before
```